  ...
  <tr>
    ...
    <td width="100%" height="85" bgcolor="#476A8E" colspan = "5">
		...
		<td align = "right">
			...
			<tr><td>
						<a href = "clicksLog1.php?redirect=http://www.brothersmanagement.com/&adID=5" target='_new'>
							<img src = "ads/brothers_468.gif" border="0">
...
<!--- NavBar ---->
  ...
  <tr>
 <td colspan = "5" background = "bckground.gif" bgcolor = "#FFFFFF"><br><h3>You must be logged in to put a book in our database!</h3><!--- Footer --->
...
<div align="center"><font size="-1">&copy;2003-2012 Bubooks.com - All rights reserved</font></div>
