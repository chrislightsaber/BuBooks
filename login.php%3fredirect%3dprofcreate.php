 ...
 <td colspan = "5" background = "bckground.gif" bgcolor = "#FFFFFF">    
		...
		<table width="100%">
 			...
 			<tr><td width="33%" align="center">
				...
				<font face="arial, verdana"><H4 align="center"><div class="indentedleft">Why should I <a href="signup.php">sign up</a>?</div></H4></font>

				<div class="indented"><p align+"left"><font face="Verdana" size="2" color="#263B4E">Registered members can </font><font face="Verdana" size="2" ><b>rate professors, sell textbooks, list classified ads, and view contact 

				info for ads.</b></font>  <font face="Verdana" size="2" color="#263B4E">Membership is free and takes only about 30 seconds. </font></p></div>	
				...
				<td width="34%">
					...
					<table align="center" width="100%">
						...
						<tr><td valign="top" align="center"><H2 align="center"><font face="verdana" color="#476A8E">BUBooks Login:</H2></font></tr></td>
						...
						<table border="1" rules = "none" cellspacing="0" cellpadding="2" bgcolor="#577A9E" bordercolor="#274A6E" align="center">
							...
							<tr>
								...
								<form method="post" name="login" action="login.php?redirect=profcreate.php">

							
							

							<td><font face="Times" size ="2" color="#FFFFFF">Username: </font></td>

				

							<td align="left"  colspan="2"><input type="text" name="usrname" size="20" maxlength="50"></td></tr>
							...
							<td><font face="Times" size="2" color="#FFFFFF">Password: </font></td>

				

							<td align="left"><input type="password" name="psswrd" size="20" maxlength="30"></td>
						...
						<table align="center"><BR>
							...
							<tr><td align="center"><a href="forgotpass.php"><font face="verdana" size="2"><B>Forgot Password?</b></font></a></tr></td>

							<tr><td align="center"><a href="signup.php"><font face="verdana" size="2"><B>Not a member? Sign Up Here.</b></font></a></td></tr>
		...
		<td width="33%"  align="center">
			...
			<font face="arial, verdana"><H4 align="center"><div class="indentedright">Forgot your password?</div></H4></font>

			<div class="indented"><p><font face="Verdana" size="2" color="#263B4E">Click the forgot password link below and enter the

			 email address you signed up with.  If this feature does not work for you, <a href="contact.php">contact us</a> or make a new account.</font></p></div>
