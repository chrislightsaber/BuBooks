...
<head>
<title>Bubooks.com - Posting Guidelines</title>
...
<UL>
<li>1.	Bubooks.com is just a venue. We are not involved in the actual transaction between the buyer and seller. 
We have no control over the quality or safety of the items advertised, the truth or accuracy of the listings, 
the ability of sellers to sell items or the ability of buyers to pay for items. We do not know whether a buyer 
or seller will complete a transaction. Bubooks is only providing the web space, nothing more. </li>
<li>2.	Because we are solely providing a venue, in the event that you have a dispute with one or more users, 
you release Bubooks.com (our officers, directors, agents, and employees) from claims, 
demands and damages (actual and consequential) of every kind and nature, known and unknown, suspected and unsuspected, 
disclosed and undisclosed, arising out of or in any way connected with such disputes. </li>
<li>3.	Bubooks reserves the right to remove any postings from the website at any time. All textbook 
ads are subject to removal 365 days after they are posted. </li>
</UL>

Professor Ratings - <div class="indented"> Do not post any inappropriate, defamatory, infringing, obscene, 
or dishonest information about your professors. Do not get personal. Do not use profanity. 

If you see a Professor rating that does not meet the above guidelines, please press the File Complaint button next to the rating 
and report it to us. We will take immediate action and delete any rating that does not meet our guidelines. <BR><BR></div>
