...
<table align="center" bordercolor= "#476A8E" border="1" rules ="ALL">
		...
		<tr><td id="text">Authentication: </td>
		<td align="left">Please type the <b>3</b> black symbols that you see</td></tr>
		
		<tr><td id="text"></td>
		<td align="left">
			<table><tr><td><img src="captcha.php" alt="captcha image"></td>
		    <td><input type="text" name="captcha" size="3" maxlength="3"></td></tr>
		    </table>
					</td></tr>
...
#1 /var/www/dustin/signup.php(130): include('/var/www/dustin...')
#2 {main}
