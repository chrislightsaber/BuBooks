<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 3.2//EN"><html><head><title>Professor Rating Complaint	</title></head>	
...
<!--- NavBar ---->
 ...
 <td colspan = "5" background = "bckground.gif" bgcolor = "#FFFFFF">	
		...
		<div align="center"><font size = "4" color = "RED">		
		Please verify that you wish to file a complaint and that this is the correct post.	</font></div>
<BR>		<table width = "80%" align = "center" cellpadding = "2" bgcolor = "#FFFFFF"	cellspacing ="0" border = "1" rules = "frame" bordercolor = "#476A8E">
				<tr><td align = "left" bgcolor="#476A8E"><font size = "4"  color="WHITE">Offending Comment</font></td></tr>			
				
		<tr><td bgcolor ="#FFFFFF"><p></p></td></tr>		
		<tr><td align = "right" bgcolor="#EEEEEE" height ="5"></td></tr>			
		<form method = "POST" action = "filecomplaint.php">						
			<tr><td align = "center" bgcolor = "#FFFFFF">				
			<textarea name="explanation" cols="70" rows="3">Please tell us why this was offensive here.  We will not accept a complaint without explanation!</textarea>	</td></tr>						
...
<a href="#" onclick="document.getElementById('captcha').src = '/securimage/securimage_show.php?' + Math.random(); return false">[ Different Image ]</a>				
			<input type="submit" value="File Complaint"></td></tr>					
			</form>	</table>	
