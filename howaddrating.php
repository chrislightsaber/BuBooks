...
<head>
<title>Bubooks.com - How to Add a Rating</title>
  ...
  <tr>
    ...
    <td width="100%" height="85" bgcolor="#476A8E" colspan = "5">
		...
		<tr><td align = "left" rowspan="2">
			<img src="logo.gif" width="261" height="64">
		</td>
		<td align = "right">
			<table align="right" border ="0" cellpadding="0" cellspacing="0">
			<tr><td>
						<a href = "clicksLog.php?redirect=http://www.grandecom.com&adID=4" target='_new'>
							<img src = "ads/BUBooks2.gif" border="0">
...
<H2 align="center"><font face="verdana" color="#476A8E">How to Add a Rating</font></H2>

<div class="indented"><font size ="4"><p>To add a rating to a listed professor, simply go to that professors rating page and look for the 
blinking link that states "Add Rating". Click on this and fill in the info. </font> </p>

<font size ="4"><p>To add an unlisted Professor, click the "Create a new Professor entry" link on the profrate home page.
Please make sure the professor you are rating is not already on the list.</p></div>
</div>
...
<div align="center"><font size="-1">&copy;2003-2008 BUBooks.com - All rights reserved</font></div>
