...
<head>
<title>Bubooks.com - Classified FAQ</title>
  ...
  <tr>
    ...
    <td width="100%" height="85" bgcolor="#476A8E" colspan = "5">
		...
		<td align = "right">
			...
			<tr><td>
						<a href = "clicksLog.php?redirect=http://www.bubooks.com/advertising.php&adID=8" target='_new'>
...
<H2 align="center"><font face="verdana" color="#476A8E">Classified FAQ</font></H2>

<div class="indented"><p>As you can probably tell, we have finally had enough time to work
on the classified ads. There is still work to be done, but the current condition of the 
classified ads is in good working condition so we decided to put it up...<BR><BR>
If you have any suggestions or comments please <a href="contact.php">contact us.</a> 
</div></p>
