...
<html>
	...
	<head><title>BUBooks.com - Textbook Search</title></head>		
	...
	<tr>
		...
		<td align="center">
			...
			<font size="2" font="verdana">Search by Title, ISBN, or Author:</font>
			...
			<input type="text" id="pattern" name="pattern" size="40" maxlength="55" value="">
	...
	<tr>
		...
		<td align="center" colspan="2"><font face="verdana" size="2"><b>--OR--</b></td>
	...
	<tr>
		...
		<td colspan = "2" align = "center">
			...
			<font size="2" font="verdana">Department:<br>
...
<table align="center" border="0">
		    <tr><td>
							...
							<a href = "clicksLog1.php?redirect=http://www.bubooks.com/advertising.php&adID=9" target='_new'>
							<img src = "ads/bubooks.gif" border="0">
...
<H3 align="center">You must enter a pattern to search by.</H3>
...

{
	...
	var arrayDept = new Array("--SELECT DEPARTMENT--","Accounting","Art","Baylor Interdisciplinary Core","Biology","Business","Business Law","Chemistry","Christian Religious Education","Economics","English","Environmental Studies","Film and Digital Media","Geography","German","History","Information Systems","Management","Marketing","Mathematics","Neuroscience","Philosophy","Physics","Political Science","Pre-Health Professions","Psychology","Religion","Sociology","Spanish","Speech Communication");
...
// Event to occur when dept is changed/selected



function onChangeHandlerDept(e) 
...
// Event to occur when text is typed in text(pattern) field



function onChangeHandlerPattern(e) 
...

{
  	...
  	myDropDown.onchange = onChangeHandlerDept;
...

{
  	...
  	myTextfld.onchange = onChangeHandlerPattern;
...
mySearchForm.onsubmit = ValidateSearch;
